...
class CCD_Admin {
	...
	public static function page() {
		...
		<?php CCD_Dashboard_Page::render_action_row(); ?>
		<tr><th><?php esc_html_e( 'Dashboard Page', 'client-content-dashboard' ); ?></th><td><?php wp_dropdown_pages( array( 'name' => 'ccd_settings[dashboard_page_id]', 'selected' => $s['dashboard_page_id'], 'show_option_none' => __( 'Select a page', 'client-content-dashboard' ) ) ); ?><p class="description"><?php esc_html_e( 'To use a different page as the client dashboard, place [client_content_dashboard] inside that page, then select it here.', 'client-content-dashboard' ); ?></p></td></tr>
		<?php CCD_Dashboard_Page::render_status_rows(); ?>
		</table></div>
